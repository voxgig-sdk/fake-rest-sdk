...
local FakeRestSDK = {}
FakeRestSDK.__index = FakeRestSDK
...
FakeRestSDK._make_feature = _make_feature


function FakeRestSDK.new(options)
  local self = setmetatable({}, FakeRestSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FakeRestSDK:options_map()
...
function FakeRestSDK:get_utility()
  return Utility.copy(self._utility)
end


function FakeRestSDK:get_root_ctx()
  return self._rootctx
end


function FakeRestSDK:prepare(fetchargs)
...
function FakeRestSDK:direct(fetchargs)
...
-- by passing it.
function FakeRestSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FakeRestSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FakeRestSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FakeRestSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FakeRestSDK.new(sdkopts)
  sdk.mode = "test"
