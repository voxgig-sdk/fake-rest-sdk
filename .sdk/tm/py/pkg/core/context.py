...
from projectname_sdk.core.control import FakeRestControl
...
class FakeRestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, FakeRestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FakeRestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FakeRestError(code, msg, self)
