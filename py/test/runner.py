...
class FakeRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeRestTestRunner.getenv("FAKEREST_TEST_LIVE")
        override = FakeRestTestRunner.getenv("FAKEREST_TEST_OVERRIDE")
        ...
        explain = FakeRestTestRunner.getenv("FAKEREST_TEST_EXPLAIN")
