...
func registerSDKWords(r *eng.Registry, client *sdk.FakeRestSDK) {
...
func runOp(client *sdk.FakeRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
