...
// FakeRest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FakeRestMakeRequest
{
    public static function call(FakeRestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FakeRestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FakeRestResponse($fetched);
        } else {
