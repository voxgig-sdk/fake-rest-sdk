...
from fakerest_sdk.utility import register

# Load features
from fakerest_sdk.feature.base_feature import FakeRestBaseFeature
from fakerest_sdk.features import _has_feature, _make_feature
...
class FakeRestSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FakeRestUtility()
        self._utility = utility

        from fakerest_sdk.config import shared_config
    ...
    def get_utility(self):
        return FakeRestUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "FakeRestSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FakeRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Category(self, data=None) -> "CategoryEntity":
        ...
        from fakerest_sdk.entity.category_entity import CategoryEntity
