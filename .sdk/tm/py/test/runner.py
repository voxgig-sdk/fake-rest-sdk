...
class FakeRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeRestTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FakeRestTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FakeRestTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
