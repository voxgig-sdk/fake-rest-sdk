...
func (sdk *FakeRestSDK) OptionsMap() map[string]any {
...
func (sdk *FakeRestSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FakeRestSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FakeRestSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FakeRestSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FakeRestSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FakeRestSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FakeRestSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FakeRestSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FakeRestSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FakeRestSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
