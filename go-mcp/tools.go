...
type Args struct {
	Entity string         `json:"entity" jsonschema:"category | comment | post | product | todo | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FakeRestSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fake-rest_list",
		Description: "List records from FakeRest. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fake-rest_load",
		Description: "Load a single record from FakeRest. " +
...
func runOp(client *sdk.FakeRestSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FakeRestSDK, name string) (sdk.FakeRestEntity, error) {
