...
// FakeRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FakeRestSDK::test)
...
{
    private const SDK_CLASS = 'FakeRestSDK';
    ...
    private const SDK_BASE = 'fakerest_sdk';
