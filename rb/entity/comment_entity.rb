...
class CommentEntity
  ...
  # @return [Array<Comment>, Array] the matching Comment items; raises FakeRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Comment, Hash] the created Comment; raises FakeRestError on failure
