...
{
    private static function utility(): FakeRestUtility
    {
        return new FakeRestUtility();
    }
    ...
    private static function ctx(array $over = []): FakeRestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FakeRestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FakeRestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FakeRestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FakeRestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FakeRestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FakeRestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FakeRestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FakeRestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FakeRestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FakeRestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FakeRestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new FakeRestResult([]),
        ]);
        [, $err] = FakeRestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FakeRestSpec([]),
            'response' => null,
            'result' => new FakeRestResult([]),
        ]);
        [, $err] = FakeRestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FakeRestSpec(['step' => 's']),
            'response' => new FakeRestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FakeRestResult([]),
        ]);
        [, $err] = FakeRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FakeRestSpec(['step' => 's']),
            'response' => new FakeRestResponse(self::resp(200, ['v' => 1])),
            'result' => new FakeRestResult([]),
        ]);
        [, $err] = FakeRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FakeRestSpec(['step' => 's']),
            'response' => new FakeRestResponse(self::resp(200, ['v' => 2])),
            'result' => new FakeRestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FakeRestMakeResponse::call($ctx);
    ...
    {
        $preset = new FakeRestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FakeRestSpec([]),
            'response' => new FakeRestResponse([]),
            'result' => new FakeRestResult([]),
        ...
        [$got, $err] = FakeRestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FakeRestResult([])]);
        [, $err] = FakeRestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FakeRestSpec([]), 'result' => null]);
        [, $err] = FakeRestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FakeRestSpec(['step' => 's']),
            'result' => new FakeRestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FakeRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FakeRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FakeRestSpec(['step' => 's']),
            'result' => new FakeRestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FakeRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FakeRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FakeRestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FakeRestSpec([]),
            'result' => new FakeRestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FakeRestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FakeRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FakeRestError('boom', 'boom');
        $utility->fetcher = function (FakeRestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FakeRestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FakeRestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FakeRestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FakeRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FakeRestResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FakeRestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FakeRestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FakeRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FakeRestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FakeRestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FakeRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FakeRestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FakeRestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FakeRestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FakeRestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FakeRestResult(['ok' => false])]);
        $this->expectException(FakeRestError::class);
        FakeRestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FakeRestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FakeRestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FakeRestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FakeRestBaseFeature();
        $b = new FakeRestBaseFeature();
        FakeRestFeatureAdd::call($ctx, $a);
        FakeRestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FakeRestBaseFeature
    {
        $f = new FakeRestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FakeRestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FakeRestContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FakeRestSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FakeRestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FakeRestResponse(['headers' => null]),
            'result' => new FakeRestResult([]),
        ]);
        FakeRestResultHeaders::call($ctx);
