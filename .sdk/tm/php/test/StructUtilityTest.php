...
// FakeRest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FakeRestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FakeRestOmni::structfix($now, Struct::undef()))
                        !== json_encode(FakeRestOmni::structfix($val, Struct::undef()))) {
