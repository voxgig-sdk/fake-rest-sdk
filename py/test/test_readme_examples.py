# FakeRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FakeRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FakeRestSDK(...) and FakeRestSDK.test(...) become
#      FakeRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fakerest_sdk"
_SDK_CLASS = "FakeRestSDK"
