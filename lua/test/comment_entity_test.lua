...
describe("CommentEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FAKEREST_TEST_COMMENT_ENTID JSON to run live")
      return
    end
...
function comment_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FAKEREST_TEST_COMMENT_ENTID")
