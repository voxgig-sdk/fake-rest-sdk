...
class PostEntity
  ...
  # @return [Post, Hash] the loaded Post; raises FakeRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Post>, Array] the matching Post items; raises FakeRestError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Post, Hash] the created Post; raises FakeRestError on failure
