...
func NewTodoEntity(client *core.FakeRestSDK, entopts map[string]any) *TodoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TodoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TodoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TodoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
