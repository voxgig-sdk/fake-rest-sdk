...
class FakeRestCacheFeature extends FakeRestBaseFeature
{
    ...
    private function _through(FakeRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
