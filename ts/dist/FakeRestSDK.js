...
exports.SDK = exports.FakeRestSDK = exports.FakeRestEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
...
Object.defineProperty(exports, "FakeRestEntityBase", { enumerable: true, get: function () { return FakeRestEntityBase_1.FakeRestEntityBase; } });
...
class FakeRestSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('FakeRestSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('FakeRestSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('FakeRestSDK: graphql: ' +
    ...
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new FakeRestSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return FakeRestSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'FakeRest' };
    }
    toString() {
        return 'FakeRest ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.FakeRestSDK = FakeRestSDK;
const SDK = FakeRestSDK;
exports.SDK = SDK;
//# sourceMappingURL=FakeRestSDK.js.map