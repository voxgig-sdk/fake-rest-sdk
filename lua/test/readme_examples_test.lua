...
local SDK_MODULE = "fake-rest_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["category"] = { ["test01"] = { id = "test01" } }, ["comment"] = { ["test01"] = { id = "test01" } }, ["post"] = { ["test01"] = { id = "test01" } }, ["product"] = { ["test01"] = { id = "test01" } }, ["todo"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
