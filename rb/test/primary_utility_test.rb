...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FakeRestOmni.make_runner(TEST_JSON_FILE, FakeRestSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FakeRestOmni.errify(err)
    end
