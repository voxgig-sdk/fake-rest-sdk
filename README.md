...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fake-rest` | `npm install @voxgig-sdk/fake-rest` |
| Python | `voxgig-sdk-fake-rest` | `pip install voxgig-sdk-fake-rest` |
| PHP | `voxgig-sdk/fake-rest` | `composer require voxgig-sdk/fake-rest` |
| Golang | `github.com/voxgig-sdk/fake-rest-sdk/go` | `go get github.com/voxgig-sdk/fake-rest-sdk/go` |
| Ruby | `voxgig-sdk-fake-rest` | `gem install voxgig-sdk-fake-rest` |
| Lua | `voxgig-sdk-fake-rest` | `luarocks install voxgig-sdk-fake-rest` |
