...
class FakeRestRbacFeature extends FakeRestBaseFeature
{
    ...
    private function _required(FakeRestContext $ctx): ?string
    {
    ...
    private function _reject(FakeRestContext $ctx, string $required): void
    {
    ...
    private function _track(FakeRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
