...
class FakeRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FakeRestSDK/1.0)';
    ...
    public static function call(FakeRestContext $ctx, string $fullurl, array $fetchdef): array
    {
