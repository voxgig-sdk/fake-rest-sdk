...
// FakeRest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FakeRestTestFeature extends FakeRestBaseFeature
{
    ...
    public function init(FakeRestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FakeRestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FakeRestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FakeRestContext $ctx, $op, $args): array
    {
