...
|---|---|---|
| `ts/` | @voxgig-sdk/fake-rest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fake-rest-sdk \
      --repository voxgig-sdk/fake-rest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fake-rest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fake-rest-sdk --id=<id>` removes it.
