...
// FakeRest SDK streaming feature
...
class FakeRestStreamingFeature extends FakeRestBaseFeature
{
    ...
    private function _iterate(FakeRestResult $result): \Generator
    {
    ...
    private function _streamable(FakeRestContext $ctx): bool
    {
