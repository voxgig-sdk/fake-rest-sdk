...
The Lua SDK for the FakeRest API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:FakeRest(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── fake-rest_sdk.lua    -- Main SDK module
...
The main module (`fake-rest_sdk`) exports the SDK constructor
