...
// FakeRest SDK clienttrack feature
...
class FakeRestClienttrackFeature extends FakeRestBaseFeature
{
    ...
    public function PostConstruct(FakeRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FakeRest-SDK';
