...
class FakeRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeRestTestRunner.getenv("FAKE_REST_TEST_LIVE")
        override = FakeRestTestRunner.getenv("FAKE_REST_TEST_OVERRIDE")
        ...
        explain = FakeRestTestRunner.getenv("FAKE_REST_TEST_EXPLAIN")
