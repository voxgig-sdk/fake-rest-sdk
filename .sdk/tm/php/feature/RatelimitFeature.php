...
// FakeRest SDK ratelimit feature
...
class FakeRestRatelimitFeature extends FakeRestBaseFeature
{
    ...
    private function _acquire(FakeRestContext $ctx): void
    {
    ...
    private function _track(FakeRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
