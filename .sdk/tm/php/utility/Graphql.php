...
class FakeRestGraphql
{
    ...
    // equivalent.
    public static function body(FakeRestContext $ctx): mixed
    {
    ...
    public static function errors(FakeRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
