...
from projectname_sdk import FakeRestSDK
from projectname_sdk.core.spec import FakeRestSpec
from projectname_sdk.core.result import FakeRestResult
from projectname_sdk.core.response import FakeRestResponse
from projectname_sdk.core.operation import FakeRestOperation
from projectname_sdk.core.error import FakeRestError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FakeRestBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FakeRestSDK.test(None, None)
        ...
        class TestInitFeature(FakeRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FakeRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FakeRestSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FakeRestSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FakeRestSDK.test(None, setup_opts)
