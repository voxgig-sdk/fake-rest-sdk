...
func NewCommentEntity(client *core.FakeRestSDK, entopts map[string]any) *CommentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CommentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
