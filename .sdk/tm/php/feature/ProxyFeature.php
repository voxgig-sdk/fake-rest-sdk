...
class FakeRestProxyFeature extends FakeRestBaseFeature
{
    ...
    public function init(FakeRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FakeRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
