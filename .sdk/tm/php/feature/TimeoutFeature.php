...
class FakeRestTimeoutFeature extends FakeRestBaseFeature
{
    ...
    private function _with_timeout(FakeRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FakeRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
